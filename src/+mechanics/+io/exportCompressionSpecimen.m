function files = exportCompressionSpecimen(study, config)
%EXPORTCOMPRESSIONSPECIMEN Export one compression specimen and its report.
arguments
    study (1,1) struct
    config (1,1) struct
end
...
if config.saveStudyMat
    files.study = fullfile(folder, "compression_specimen.mat");
