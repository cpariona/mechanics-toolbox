...
if isfield(specimen, "analysis") && ...
    ...
    curveTable.StrainStandardUncertainty = ...
        uncertainty.strainStandardUncertainty(:);
    curveTable.StressStandardUncertainty = ...
        uncertainty.stressStandardUncertainty(:);
    curveTable.StrainRelativeStandardUncertainty = ...
        uncertainty.strainRelativeStandardUncertainty(:);
    curveTable.StressRelativeStandardUncertainty = ...
        uncertainty.stressRelativeStandardUncertainty(:);
end
