...
fprintf(fileId, ["- Model selection is conditional on the candidate models, " ...
    "fit configuration, and reliability filters.\n"]);
fprintf(fileId, ["- Parameters are summarized only within the same model " ...
    "family and parameter identity.\n"]);
fprintf(fileId, ["- Adjusted p-values and effect sizes should be interpreted " ...
    "with specimen counts and diagnostic quality.\n"]);
