function config = compressionSpecimenConfig()
%COMPRESSIONSPECIMENCONFIG Default single-specimen compression configuration.
...
config.export.outputFolder = "results/compression-specimen";
