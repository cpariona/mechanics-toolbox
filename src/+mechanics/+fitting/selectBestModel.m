...
requiredVariables = [ ...
    ...
    "FullWindowBIC", "MaximumSharedDomainNormalizedRMSE"];
...
if isempty(eligibleRows)
    selection.reason = ...
        "No model satisfied fitting, convergence, and finite-result requirements.";
    return;
end
...
selection.reason = sprintf( ...
    ['Models with full-window RMSE within %.6g of the minimum were ' ...
     'treated as practically equivalent; the most parsimonious model was ' ...
     'selected and %s plus shared-domain response sensitivity were used ' ...
