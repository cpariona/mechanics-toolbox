...
% Summarize tangent modulus between 0.01 and 0.10 compression-strain
% magnitude. Stored compression strain remains physically negative.
analysisConfig.summaryStrainRangeMode = "explicit";
analysisConfig.summaryStrainRange = [-0.10, -0.01];
