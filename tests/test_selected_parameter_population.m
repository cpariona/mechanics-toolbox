...
parameterTable = table( ...
    ["neo";"mr";"mr";"yeoh2";"yeoh2";"yeoh3";"yeoh3";"yeoh3"], ...
    repmat("all",8,1), ...
    ["neo-hookean";"mooney-rivlin";"mooney-rivlin"; ...
     "yeoh-second-order";"yeoh-second-order"; ...
     "yeoh-third-order";"yeoh-third-order";"yeoh-third-order"], ...
    ["mu";"C10";"C01";"C10";"C20";"C10";"C20";"C30"], ...
    [10;3;2;5;7;4;7;9], ...
    'VariableNames', {'SpecimenId','Group','ModelName','Parameter','Value'});

result = mechanics.statistics.deriveInitialShearModulus(parameterTable);
verifyEqual(testCase, result.values.SpecimenId, ["neo";"mr";"yeoh2";"yeoh3"]);
...
expectedKeys = [ ...
    ...
    "yeoh-third-order::C10"; ...
    "yeoh-third-order::C20"; ...
    "yeoh-third-order::C30"];
...
batch = mechanics.workflow.fitConsensusModelAcrossSpecimens( ...
    ...
    ["neo-hookean";"yeoh-second-order";"yeoh-third-order"], ...
    fitConfig, config);
end
