function tests = test_fit_diagnostics_workflow
...
analysis = mechanics.workflow.runFitDiagnostics("neo-hookean", strain, stress, context, fitConfig, config);
...
verifyTrue(testCase, isfield(analysis.residualDiagnostics, "hasSystematicStructure"));
...
stress = mechanics.models.evaluateModel("neo-hookean", strain, 15, context);
