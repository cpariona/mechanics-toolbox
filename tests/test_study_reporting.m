...
verifyFalse(testCase, isfield(files, "fractureMetrics"));
end
...
study.analysis.summary = table(1, "sample-01", "sample-01", "processed", false, 4, 3, 3, 4, 0, true, "", 4, 0, 0, 0.3, 3, 10, "neo-hookean", 0, 1, "", "", 'VariableNames', {'Index','SpecimenId','SheetName','Status','FractureDetected','PeakIndex','PeakForce','PeakDisplacement','AnalysisEndIndex','PostPeakDropFraction','QualityPassed','FailedQualityChecks','ObservationCount','NonfiniteFraction','DisplacementReversalFraction','MaximumStrain','MaximumStress','MedianTangentModulus','BestModel','BestModelRMSE','BestModelRSquared','ErrorIdentifier','ErrorMessage'});
