...
batch = mechanics.workflow.compareModelsAcrossSpecimens(specimens, ["neo-hookean", "mooney-rivlin"], mechanics.config.fittingConfig(), localConfig());
...
specimens = localSpecimens();
batch = mechanics.workflow.compareModelsAcrossSpecimens(specimens, "neo-hookean", mechanics.config.fittingConfig(), localConfig());
